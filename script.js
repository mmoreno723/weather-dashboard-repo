...
function getCurrentApi() {
    ...
    var requestUrl = `https://api.openweathermap.org/data/2.5/weather?q=` + search.value + `&units=imperial&appid=6db1fa369ae9cc9c6649966d9a9904bd`;
    ...
    fetch(requestUrl)
        ...
        .then(function (data) {
            ...
            var uviUrl = "https://api.openweathermap.org/data/2.5/onecall?lat=" +
            lat +
            "&lon=" +
            lon +
            "&exclude=minutely,hourly&units=imperial&appid=6db1fa369ae9cc9c6649966d9a9904bd";
            $("#historyBtn").append(`<a class="btn btn-dark" id="searchResult"> ${search.value} </a>`);
